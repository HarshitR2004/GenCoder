"""
Django settings for gencoder project.
...
SECRET_KEY = 'django-insecure-r8s*fx(%q!9#1&(h4f57r#%lvlzfg_&dvmgj+z6iyp(m@$qn5%'
...
WSGI_APPLICATION = 'gencoder.wsgi.application'
